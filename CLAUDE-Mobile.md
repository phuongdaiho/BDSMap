...
├── sw.js                   ← Service Worker (offline cache, hiện v10)
...
### 3. Auth (đăng nhập / đăng ký / quên mật khẩu)
...
- **Forgot password:** `auth.sendPasswordResetEmail(email)` — Firebase tự gửi email link reset; app chỉ cần gọi hàm và hiện thông báo thành công/lỗi
